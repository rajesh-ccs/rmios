<%-- 
    Document   : podcastshare
    Created on : 17 Aug, 2017, 2:20:00 PM
...
<%  
    ...
    if(request.getParameter("id")!=null && request.getParameter("id").length()>0){
    	paramVal = request.getParameter("id");
    }
%>
...
<head>  
    ...
    <meta property="al:android:url" content="<%=request.getContextPath()%>/podcastshare.jsp?id=<%= paramVal%>"/>
    <meta property="al:android:package" content="org.radiomango.app"/>
    <meta property="al:android:app_name" content="Radio Mango"/>
    <meta property = "al:ios:url" content = "rmios://podcast?id=<%= paramVal%>" />
    ...
    <meta name="twitter:app:url:googleplay" content="<%=request.getContextPath()%>/podcastshare.jsp?id=<%= paramVal%>"> 
    <meta name = "twitter:app:id:iphone" content = "956511007"/>
    <meta name = "twitter:app:url:iphone" content = "rmios://podcast?id=<%= paramVal%>"/ >
    <meta name = "twitter:app:id:ipad" content = "956511007" />
    <meta name = "twitter:app:url:ipad" content = "rmios://podcast?id=<%= paramVal%>"/ >
